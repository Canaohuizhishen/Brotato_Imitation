...
var strings = {
    ...
    "未实现":         ["未实现", "未實現", "WIP", "À venir", "未実装", "미구현", "В разработке", "W budowie", "No implementado", "Não implementado", "In Arbeit", "Yapım aşamasında", "Non implementato"],
    ...
    "燃烧速度":       ["燃烧速度", "燃燒速度", "Burn Rate", "Taux de brûlure", "燃焼率", "화상 속도", "Скорость горения", "Szybkość spalania", "Tasa de quemadura", "Taxa de queimadura", "Brennrate", "Yanma Oranı", "Tasso di bruciatura"],
    "命中率":          ["命中率", "命中率", "Accuracy", "Précision", "命中率", "명중률", "Точность", "Celność", "Precisión", "Precisão", "Genauigkeit", "İsabet", "Precisione"],

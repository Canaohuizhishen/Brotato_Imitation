    ...
    Grid {
        ...
        Button {
            ...
            Image {
                ...
                height: width*1.3513
                source: randomSelect.pressed || randomSelect.hovered || roleGrid.selectedObjectName == randomSelect.objectName ? "/images/问号.png" :"/images/问号2.png"
                anchors.centerIn: parent
            }
        ...
        Button {
            ...
            Image {
                ...
                height: width*1.158
                source: wellRounded.pressed || wellRounded.hovered || roleGrid.selectedObjectName == wellRounded.objectName ? "/images/全能者头像.png":"/images/全能者头像2.png"
                anchors.centerIn: parent
            }
        ...
        Button {
            ...
            Image {
                ...
                height: width*1.13
                source: mutant.pressed || mutant.hovered || roleGrid.selectedObjectName == mutant.objectName ? "/images/异变体头像.png":"/images/异变体头像2.png"
                anchors.centerIn: parent
            }
        ...
        Repeater {
            ...
            delegate: Button {
                ...
                Image {
                    ...
                    height: width*1.305
                    //import "./components"
                    source: parent.pressed || parent.hovered || roleGrid.selectedObjectName == parent.objectName ? "/images/锁.png" : "/images/锁2.png"
                    anchors.centerIn: parent
                }
